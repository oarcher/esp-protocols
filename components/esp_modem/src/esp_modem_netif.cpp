...
namespace esp_modem
{
    ...
    Netif::Netif(std::shared_ptr<DTE> e, esp_netif_t *ppp_netif) : ppp_dte(std::move(e))
    {
        ...
        ESP_LOGI("esp_modem_netif", "IIIIIIIIIIIIIIIIIIII events registered");
    }
    ...
    void Netif::start()
    {
        ...
        ESP_LOGI("esp_modem_netif", "IIIIIIIIIIIIIIIIIIII start");
    }
    ...
    void Netif::stop()
    {
        ...
        ESP_LOGI("esp_modem_netif", "IIIIIIIIIIIIIIIIIIII stop");
    }
    ...
    Netif::~Netif()
    {
        ...
        ESP_LOGI("esp_modem_netif", "IIIIIIIIIIIIIIIIIIII events unregistered");
    }

    void Netif::wait_until_ppp_exits()
    {
        ESP_LOGI("esp_modem_netif", "IIIIIIIIIIIIIIIIIIII wait_until_ppp_exits start");
        signal.wait(PPP_EXIT, 30000);
        ESP_LOGI("esp_modem_netif", "IIIIIIIIIIIIIIIIIIII wait_until_ppp_exits stop");
    }
